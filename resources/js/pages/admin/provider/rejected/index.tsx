...
export default function Pending({ providers, meta, filters: initialFilters }) {
    ...
    const [filters, setFilters] = useState({
        ...
        status: initialFilters.status || 'rejected', // ডিফল্ট pending
    ...
    useEffect(() => {
        ...
        router.get(route('providers.rejected'), filters, {
            preserveState: true,
            replace: true,
            preserveScroll: true,
        });
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4">
                {/* <div className="my-4 flex items-center justify-between">
                    <h1 className="text-2xl font-bold">Rejected Providers</h1>
