...
export default function Pending({ providers, meta, filters: initialFilters }) {
    ...
    const [filters, setFilters] = useState({
        ...
        status: initialFilters.status || 'inactive', // ডিফল্ট pending
    ...
    useEffect(() => {
        ...
        router.get(route('providers.inactive'), filters, {
            preserveState: true,
            replace: true,
            preserveScroll: true,
        });
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Inactive Providers" />
            <div className="p-4">
                <div className="my-4 flex items-center justify-between">
                    <h1 className="text-2xl font-bold">Inactive Providers</h1>
